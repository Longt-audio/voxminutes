#!/bin/bash
# GPU-accelerated development script for VoxMinutes
...
echo -e "${BLUE}🚀 VoxMinutes GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting VoxMinutes in development mode...${NC}"
echo ""
