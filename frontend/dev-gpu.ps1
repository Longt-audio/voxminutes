# GPU-accelerated development script for VoxMinutes (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for VoxMinutes" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting VoxMinutes in development mode..." -ForegroundColor Blue
Write-Host ""
