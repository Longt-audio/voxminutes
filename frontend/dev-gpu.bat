@echo off
REM VoxMinutes GPU-Accelerated Development Script for Windows
...
echo.
echo ========================================
echo   VoxMinutes GPU-Accelerated Development
echo ========================================
echo.
...
echo.
echo 📦 Starting VoxMinutes in development mode...
echo.
...
echo.
echo ========================================
echo   VoxMinutes GPU Development Script - Help
echo ========================================
echo.
echo USAGE:
...
echo   VoxMinutes in development mode with optimal hardware acceleration:
echo.
