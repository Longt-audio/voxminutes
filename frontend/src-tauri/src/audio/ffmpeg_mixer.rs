...
/// Runtime-configurable audio processing feature flags.
/// Toggled via Tauri commands (get_audio_processing_flags / set_audio_processing_flags).
pub static RNNOISE_APPLY_ENABLED: AtomicBool = AtomicBool::new(false);
pub static AGC_ENABLED: AtomicBool = AtomicBool::new(false);
