@echo off
REM VoxMinutes Build Script for Windows
...
echo 🚀 Building VoxMinutes application...
...
echo.
echo ========================================
echo    VoxMinutes Build Script - Help
echo ========================================
echo.
echo USAGE:
...
echo.
echo DESCRIPTION:
echo   This script builds the VoxMinutes Tauri application for Windows.
